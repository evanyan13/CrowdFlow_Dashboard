...
const TotalVisitsModal = ({ open, hideModal }) => {
                  ...
                  <div className="sm:flex sm:items-start h-full">
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left h-full w-full">
                      ...
                      <div className="mt-2 w-full h-full">
                        <iframe
                          src="https://console-intl.huaweicloud.com/dlv/vision/share/?id=783adb4d694142949d9be6144302dfe3&locale=en-us&region=ap-southeast-3"
                          height="100%"
                          width="800vw"
                        />
                      </div>
...
export default TotalVisitsModal;
